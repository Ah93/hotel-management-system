    ...
    <div class="container">
       ...
       <img class="img-responsive" src="images/home_banner.jpg" style="width:100%; height:180px;">      
        ...
        <div class="w3-content w3-section">
            ...
            <img class="mySlides w3-animate-fading" src="images/home_gallary/7.jpg" style="width:100%; height:450px;">
        ...
        <hr>
        <div class="row" id="about" style="color: #ed9e21">
        ...
        <div class="row" style="color: #ffbb2b">
            <div class="col-md-4 wellfix">
              ...
              Address : Hargeisa Somaliland<br>
              Mail : projectworldsoffcial@gmail.com <br>
            </div>
            <div class="col-md-4"></div>
            <div class="col-md-4 wellfix">
                <h4><strong>Powered By</strong></h4><hr>
                <a href="#">Cyber Bloom Hargeisa, Software Company</a>
