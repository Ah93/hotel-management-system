...
{ 
    extract($_REQUEST); 
    $result=$user->edit_all_room($checkin, $checkout, $name, $num_of_night, $cus_id, $phone, $id, $room_price, $username);
    if($result)
    {
          ...
          <h2><?php echo  $row['room_cat']?></h2>
            ...
            <form action="" method="post" name="room_category">
               ...
               <div class="form-group">
				...
				<div class="form-group">
                    <label for="phone">Enter How Many Nights to stay:</label>
                    <input type="number" class="form-control" name="num_of_night" value="<?php echo $row['num_of_night']?>" required>
                </div>
				<div class="form-group">
                    <label for="phone">Enter ID Number:</label>
                    <input type="text" class="form-control" name="cus_id" value="<?php echo $row['cus_id']?>" required>
                </div>
                <div class="form-group">
