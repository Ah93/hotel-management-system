...
<body>
    <div class="container">
       ...
       <img class="img-responsive" src="images/home_banner.jpg" style="width:100%; height:180px;">      
				...
				<ul class="nav navbar-nav navbar-right">
                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><?php echo $username?><span class="caret"></span></a>
						<ul class="dropdown-menu">
						  <li><a href="add_room_number.php?q=logout">Logout</a></li>
						</ul>
					</li>
                </ul>
            </div>
        ...
        $sql="SELECT * FROM rooms where room_number='0'";
...
//               ********************************************** Show Room Category***********************
                while($row = mysqli_fetch_array($result))
                {
                    ...
                    echo "
                            ...
                            &nbsp;&nbsp;
							<a href='./roomNum.php?room_id=".$row['room_id']."'><button class='btn btn-primary button'>Add Room Number</button></a>
                            </div>
