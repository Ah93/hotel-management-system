				...
				<ul class="nav navbar-nav navbar-right">
                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><?php echo $username?><span class="caret"></span></a>
						<ul class="dropdown-menu">
						  <li><a href="checkoutPage.php?q=logout">Logout</a></li>
						</ul>
					</li>
                </ul>
            </div>
...
//               ********************************************** Show Room Category***********************
                while($row = mysqli_fetch_array($result))
                {
                    ...
                    echo "
                            ...
                            &nbsp;&nbsp;
                            <a href='./checkout.php?room_id=".$row['room_id']."'><button class='btn btn-primary button'>Checkout</button></a>
                            </div>
