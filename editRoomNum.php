...
{ 
    extract($_REQUEST); 
    $result=$user->edit_room_number($room_number, $room_id);
    if($result)
    {
           ...
           <h2>Edit Room Number</h2>
            ...
            <form action="" method="post" name="room_category">
               <div class="form-group">
                    <label for="price">New Romm Number:</label>
                    <input type="text" class="form-control" name="room_number" value="<?php echo $row['room_number'] ?>" required>
                </div>
                <button type="submit" class="btn btn-lg btn-primary button" name="submit">Update</button>

               <br>
                <div id="click_here">
                    <a href="./edit_room_number.php">Back</a>
                </div>
